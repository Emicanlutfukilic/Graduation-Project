...
bno055_vector_t quaternionMultiply(bno055_vector_t q1, bno055_vector_t q2) {
...
bno055_vector_t quaternionConjugate(bno055_vector_t q) {
    bno055_vector_t result;
    result.w = q.w;
    result.x = -q.x;
    result.y = -q.y;
...
double quaternionDotProduct(bno055_vector_t q1, bno055_vector_t q2) {
    return q1.w * q2.w + q1.x * q2.x + q1.y * q2.y + q1.z * q2.z;
}

double quaternionAngle(bno055_vector_t q1, bno055_vector_t q2) {
    double dotProduct = q1.w * q2.w + q1.x * q2.x + q1.y * q2.y + q1.z * q2.z;
    double magnitudeProduct = sqrt(q1.w * q1.w + q1.x * q1.x + q1.y * q1.y + q1.z * q1.z) *
                             sqrt(q2.w * q2.w + q2.x * q2.x + q2.y * q2.y + q2.z * q2.z);
